    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lrr', require('telescope.builtin').lsp_references, 'Goto References')
          ...
          map('<leader>lrd', require('telescope.builtin').lsp_definitions, 'Goto Definition')

          -- WARN: This is not Goto Definition, this is Goto Declaration.
          --  For example, in C this would take you to the header.
          map('<leader>lrD', vim.lsp.buf.declaration, 'Goto Declaration')
          ...
          map('<leader>lrt', require('telescope.builtin').lsp_type_definitions, 'Goto Type Definition')
